...
description: "Sweep this conversation into Harbor tasks with explicit per-task acceptance criteria. Forks the default sweep flow by asking Q1 as the primary task-scoped acceptance question, deriving Q2 verification probes for confirmation, defaulting Q3 worker instructions, and proposing Q4 repo-default behavior, then embedding the answers as fixed task-description sections. Use whenever the user wants to push work to the Harbor board in this repo."
